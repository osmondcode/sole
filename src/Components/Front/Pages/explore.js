...
const explore = ({trendingSongs, playList, genresSongs, playlistsAdd, isLiked, setPlayList, HandlePlaySong, playSingle}) => {
  return (
    <div className='lg:w-full md:mt-0 2sm:mt-[10vh] mt-[4vh] w-full min-h-[88vh] overflow-x-hidden overflow-y-scroll flex flex-col pb-[5vh] items-center justify-center flex-wrap 2sm:pt-0 pt-[7vh]'>
